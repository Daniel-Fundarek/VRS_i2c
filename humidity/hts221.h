...
//#define HTS221_DEVICE_WRITE_ADDRESS 0xBF
...
#define HTS221_RESET_CONTROL_REG1 ~(0x1<<7 | 0x7) // use =& to reset register
#define HTS221_SET_PD_CONTROL_REG1 0x1<<7 // use |= to set PD
#define HTS221_RESET_PD_CONTROL_REG1 ~0x1<<7 // use &= to reset PD

#define HTS221_SET_BDU_CONTROL_REG1 0x1<<2 //use |= to set BDU
#define HTS221_RESET_BDU_CONTROL_REG1 ~0x1<<2 //use &= to reset BDU

#define HTS221_1HZ_CONTROL_REG1 0xFD  //use &= to set 1HZ temperature and humidity frequency
#define HTS221_7HZ_CONTROL_REG1 0xFE //use &= to set 7HZ temperature and humidity frequency
#define HTS221_12.5HZ_CONTROL_REG1 0xFF //use &= to set 12.5HZ temperature and humidity frequency


#define HTS221_CONTROL_REG2 0x21

#define HTS221_RESET_CONTROL_REG2 ~(0x1<<7 | 0x3) // use =& to reset register
#define HTS221_SET_BOOT_CONTROL_REG2 0x1<<7 //use |= to set boot
#define HTS221_RESET_BOOT_CONTROL_REG2 ~0x1<<7 //use &= to set boot

#define HTS221_SET_HEATER_CONTROL_REG2 0x2 //use |= to set heater
#define HTS221_RESET_HEATER_CONTROL_REG2 ~0x2 //use &= to reset heater
